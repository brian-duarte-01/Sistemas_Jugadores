...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Jugador</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="titulo">
        <h1 class="ti">Listar Jugadores</h1>
    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Nuevo Jugador</h1>
    ...
    <div class="container">
        <div class="table table-responsive">
            <table class="table table-dark">
                ...
                <tbody>
                    <?php
                    $sql = $con->query("SELECT * FROM jugadores");
                    while ($lista = $sql->fetch_assoc()) {


                    ?>
                        <tr>
                            <td><?php echo $lista['id_jugador'] ?></td>
                            <td><?php echo $lista['no_jugador'] ?></td>
                            <td><?php echo $lista['nombre'] ?></td>
                            <td><?php echo $lista['apellido'] ?></td>
                            <td><?php echo $lista['fecha_nacimiento'] ?></td>
                            <td><?php echo $lista['url_foto'] ?></td>
                            <td><?php echo $lista['nombre_equipo'] ?></td>
                            <td>
